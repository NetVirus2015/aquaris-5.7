...
const NVRAM_LENS_PARA_STRUCT OV12830AF_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // AF NVRAM
    {
         ...
         0,  // i4MacroIdxOffset
        {
          ...
          100,//10000,  // i4FV_CHANGE_OFFSET;        
          5,//8,  // i4FV_CHANGE_CNT;  //12--->8
          0,  // i4GS_CHANGE_THRES;    
          20,  // i4GS_CHANGE_OFFSET;    
          6,//12,  // i4GS_CHANGE_CNT;            
          4,//12,  // i4FV_STABLE_THRES;         // percentage -> 0 more stable  
          100,//10000,  // i4FV_STABLE_OFFSET;        // value -> 0 more stable
          3,//6,  // i4FV_STABLE_NUM;           // max = 9 (more stable), reset = 0
          3,//6,  // i4FV_STABLE_CNT;           // max = 9                                      
          4,//12,  // i4FV_1ST_STABLE_THRES;        
          100,//10000,  // i4FV_1ST_STABLE_OFFSET;
